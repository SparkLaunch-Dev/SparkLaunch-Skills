...
- OpenAI Scan Tools has succeeded against `https://sparklaun.ch/api/mcp/` and discovered exactly 107 tools for the deployed service `1.8.0` candidate under 33 OAuth scopes. The retained 61-tool direct scan and 59-tool portal scan are historical evidence and do not satisfy this gate.
