...
Scope: the fourteen `sparkclose.*` descriptors in the candidate snapshot, plus their
...
private investment metadata, company-recorded evidence, first-party agreement and
signing workflows, receipt reconciliation, and finalization of internal closing
