...
3. Report status, last update, blockers, warnings, safe participant progress, and returned next action. Keep private fields, identifiers, and version values out of the conversation.
